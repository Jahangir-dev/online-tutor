...
<!-- <title>Study Space</title> -->
   ...
   <body>
      <div class="container-fluid p-0">
         <div class="bg-black d-flex p-4">
            ...
            <!-- <span class="text-white mr-5" style="font-weight:bold;margin-top: 15px;">BECOME A TUTOR</span> -->
            <a href="{{route('teacher-info')}}" class="text-white mr-5" style="font-weight:bold;margin-top: 15px;">BECOME A TUTOR</a>
         ...
         <div class="row">
            <div class="col-lg-6">
               <div class="banner_text">
                  <h1 style="margin-top: 5rem;">Explore <br> Tutoring</h1>
      ...
      <div class="container mt-lg-5">
         ...
         <div class="instrument-main mt-5">
            <div class="instrument">
               <h2>Tutors for Instruments</h2>
            </div>
            <section class="center slider">
              @foreach($gigs['Instruments'] as $i)

               <div class="slider_main">
                  <div class="slider_innerImg position-relative">
                     <img src="{{$i->image}}" alt= "instrument-img" style="height:200px;width: 100%; ;"  class="img-fluid">
                    <a href="{{route('instrument-gig-view',['id'=>$i->id])}}"> <span style="    background: hsl(0deg 0% 0% / 64%);
    color: #fff;
    padding: 2px 10px;
    border-radius: 20px;
    position: absolute;
    ...
    left: 10px;">{{$i->gig_title}}</span></a>
         ...
         <div class="language-main mt-5">
            <div class="instrument">
               <h2>Tutors for Languages</h2>
            </div>
            <section class="center slider">
                @foreach($gigs['Languages'] as $i)
               <div class="slider_main">
                  <div class="slider_innerImg position-relative">
                     <img src="{{$i->image}}" style="height:200px;width: 100%; ;" alt= "instrument-img" class="img-fluid">
                    <a href="{{route('language-gigs-view',['id'=>$i->id])}}">  <span style="    background: hsl(0deg 0% 0% / 64%);
    color: #fff;
    padding: 2px 10px;
    border-radius: 20px;
    position: absolute;
    ...
    left: 10px;">{{$i->gig_title}}</span></a>
         ...
         <div class="school-main mt-5">
            <div class="instrument">
               <h2>Tutors For School</h2>
            </div>
            <section class="center slider">
          @foreach($gigs['School'] as $i)
               ...
               <div class="slider_main">
                  <div class="slider_innerImg position-relative">
                   ...
                   <a href="{{route('school-gigs-view',['id'=>$i->id])}}">   <span style="    background: hsl(0deg 0% 0% / 64%);
    color: #fff;
    padding: 2px 10px;
    border-radius: 20px;
    position: absolute;
  ...
  <p>{{$i->users->name}}</p>
            ...
            @foreach($teacher as $t)      
               <div class="slider_main">
                  <div class="slider_innerImg tutorSlider position-relative">
                     <img src="{{$t->image}}" style="width:100%;height:250px;" alt= "instrument-img" class="img-fluid">


                     <a href="{{route('new-teacher-view',['id'=>$t->id])}}"> <span style="
    color: #fff;
    padding: 5px 10px;
    border-radius: 20px;
    position: absolute;
    ...
    width: 100%;">{{$t->about_yourself}}</span></a>
