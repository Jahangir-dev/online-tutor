    ...
    width: 55%;margin-left: 6rem;" alt ="User images" height="180px" width="180px"class="user_image" >
            ...
            <div class="col-7">
               <div class="course_text px-3">
                  <h5 class="text_orange mt-2" style="font-size:20px;">Active Orders</h5>
               </div>
               <div class="courses_section mb-4">
                  <div class="row">
                     ...
                     <div class="col-4 mb-4 mt-4">
                        <div class="text_orange text-center student_course_details" style="width: 122%;">
                        <div class="position-relative">
                           ...
                           <div class="form-group">
                              ...
                              <span class="w-50 float-right">{{date('Y-m-d h:i:sa',strtotime($o->form_offerTime))}}</span>
                           </div>


                           <div class="form-group">
                              <span class="w-50 float-left">Duration To</span>
                              <span class="w-50 float-right">{{date('Y-m-d h:i:sa',strtotime($o->to_offerTime))}}</span>
                           </div>
