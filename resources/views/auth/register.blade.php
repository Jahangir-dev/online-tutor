...
<body>
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100" style="width: 600px;background-color: #fbf3f3;">
                <form class="login100-form validate-form" method="post" action="{{route('register-save')}}">
                    @csrf
                    <span class="login100-form-title p-b-26" style="    font-family: 'Poppins-Medium';
                     font-size: 27px;">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
                        ...
                        <span class="focus-input100" data-placeholder="Addresss"></span>
                    </div>
